...
public class PageController {
	...
	private EmailSenderService senderService;
	 ...
	 @GetMapping("/flutter-program")
     public String flutterPage() {
	
		 return "flutterPage.html";
		 
	 }
	 
	 @GetMapping("/apex-academic-centre-portfolio")
     public String apexPage() {
	
		 return "apexportfolio.html";
		 
	 }
	 
	 @GetMapping("/blaq-market-portfolio")
     public String blaqPage() {
	
		 return "blaqportfolio.html";
		 
	 }
	 
	 
	 @GetMapping("/talent-elevate-portfolio")
     public String talentPage() {
	
		 return "talentportfolio.html";
		 
	 }
	 
	 
	 @PostMapping("/get-in-touch")
     public String sendEmail( @RequestParam("name")  String name ,  @RequestParam("email")  String email ,  @RequestParam("message")  String message, @RequestParam("number")  String cell  ) {
